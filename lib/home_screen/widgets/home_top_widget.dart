...
class FurnitureCategory extends StatelessWidget {
  final FurnitureCatg item;
   Color furnitureCateDisableColor = Color(0xFF9E9595);
   Color profile_info_background = Color(0xFF9247FF);
   Color profile_info_categories_background = Color(0xFFF6F5F8);
